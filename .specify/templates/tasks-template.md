...
**Independent Validation**: [How to verify this story works on its own via manual validation]
...
- **User Story 2 (P2)**: Can start after Foundational (Phase 2) - May integrate with US1 but should be independently deliverable
- **User Story 3 (P3)**: Can start after Foundational (Phase 2) - May integrate with US1/US2 but should be independently deliverable
